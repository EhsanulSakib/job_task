...
const Footer = () => {
  return (
    <div className='bg-quaternary py-8 lg:py-16'>
      <div className='flex flex-col justify-between w-full xl:w-3/5 px-[1%] xl:px-[0%] mx-auto gap-8'>
        <div className='w-full grid grid-cols-2 md:grid-cols-4 gap-4 gap-y-16'>
          ...
          <div className='flex flex-col gap-4'>
            <h2 className='text-black/50'>Categories</h2>
          ...
          {/* third Section */}
          <div className='flex flex-col gap-4'>
            <h2 className='text-black/50'>Resources</h2>
          ...
          {/* fourth Section */}
          <div className='flex flex-col gap-4'>
            <h2 className='text-black/50'>Support</h2>
        ...
        <div>
          <h2 className='text-black/50'>© 2024 EduPath. All rights reserved</h2>
        </div>
